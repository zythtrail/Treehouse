  ...
  [48],
  {
    97048: function (i, e, o) {
      ...
      m.type,
        ...
        u.name,
        g.Chromium;
      var C = (a = m.type) === v.Mobile || a === v.Tablet || E(),
        q =
          (m.type,
          v.Mobile,
          m.type === v.Tablet || E(),
          ...
          u.name,
          g.Firefox,
          (r = u.name) === g.Safari || r === g.MobileSafari);
      u.name,
        g.Opera,
                      ...
                      typeof (s = c[r]) === b && s.length > 0
                        ? 2 === s.length
                          ...
                          ? typeof s[1] !== t || (s[1].exec && s[1].test)
                            ? (this[s[0]] = d ? d.replace(s[1], s[2]) : void 0)
                            : (this[s[0]] = d
                                ? s[1].call(this, d, s[2])
                                : void 0)
                          : 4 === s.length &&
          ...
          Q = {
            ...
            device: [
              ...
              [
                [m, Z],
                l,
                [c, Y, { tablet: ["p10001l", "w7001"], "*": "mobile" }],
              ],
